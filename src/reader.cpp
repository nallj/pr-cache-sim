...
/* PUBLIC */
	...
	bool reader::isFileValid(){ return is_valid_; }

	std::multimap<std::string, std::string> reader::getParams(){ return param_dictionary_; }

	std::vector<std::string> reader::getData(){ return data_body_; }
