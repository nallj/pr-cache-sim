...
/* PUBLIC */
	storageUnit::storageUnit() :
		unit_size_(0), read_latency_(0), search_latency_(0),
		child_unit_(NULL) { }

	storageUnit::storageUnit(unsigned unit_size, unsigned short read_latency, unsigned short search_latency) :
		unit_size_(unit_size), read_latency_(read_latency),
		search_latency_(search_latency), child_unit_(NULL) { // , parent_unit_(NULL)
...
/*	}
	...
	//std::vector<module*>& storageUnit::getModuleTable() { return module_table_; }

	//module* storageUnit::getModule(unsigned module_index) { return module_table_[module_index]; }

	memoryLevel* storageUnit::getChild() { return child_unit_; }
	...
	void storageUnit::setChild(memoryLevel* child_level) { child_unit_ = child_level; }
